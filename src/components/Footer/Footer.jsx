...
const Footer = () => {
  return (
    <>
      <div className="bg-[#101727]  mt-56 grid grid-col-1 md:grid-cols-2 lg:grid-cols-3 pt-20 ml-0 space-y-20 md:space-y-12 lg:space-y-0 ">
        <div className="ml-4 lg:ml-20 text-white">
        ...
        <div className="grid grid-cols-3  text-white pl-1  lg:pl-12 md:pl-0 ml-10 ">
          <div className="leading-9">
            <h3 className="text-xl  font-bold">Product</h3>
            <div className="opacity-80 md:text-sm md:leading-8 lg:text-base">
              <p>Features</p>
              <p>Pricing</p>
              <p>Templates</p>
              <p>Integrations</p>
      ...
      <div className="bg-[#101727] pb-10">
        <div className="max-w-[1100px] mx-auto flex flex-col md:flex-row items-center justify-between">
          <h2 className="text-[16px] text-[#FAFAFA] opacity-50 pb-10 md:pb-0 pl-10 lg:pl-0">
